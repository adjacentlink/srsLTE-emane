...
void enb_initialize(srslte::log * log_h, uint32_t sf_interval, uint32_t physical_cell_id, srslte_cp_t cp, float ul_freq, float dl_freq, int nprb, EMANELTE::MHAL::mhal_config_t & mhal_config,  rrc_cfg_t * rrc_cfg);

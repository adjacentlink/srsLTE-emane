...
void cc_worker::update_measurements()
{
  ...
  dl_metrics.sinr     = phy->avg_snr_db_cqi[cc_idx] = ue_dl.chest_res.snr_db         ? ue_dl.chest_res.snr_db         : rssi;
  dl_metrics.rssi     = phy->avg_rssi_dbm[cc_idx]   = rssi;
  dl_metrics.rsrp     = phy->avg_rsrp_dbm[cc_idx]   = rssi;
  dl_metrics.pathloss = phy->pathloss[cc_idx]       = 0.0;
#endif
  Debug("cc_idx %d, avg_noise %3.3f, avg_rsrp_dbm %3.3f, avg_rsrq_db %3.3f, avg_rssi_dbm %3.3f, pathloss %3.3f, avg_snr_db_cqi % 3.3f\n",
       cc_idx,
